...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.androidsfuture.museumsDC/databases/";
    private static String DB_NAME = "museumsDC01";
  ...
  /**
	...
	public Cursor listSmith(){
		
		return myDataBase.query(TABLE_NAME, FROM_MANSIONS, KEY_TYPE + " like '%smith%'", null, KEY_MUSEUM, null, KEY_MUSEUM);
	}
